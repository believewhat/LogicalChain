...
def main(args):
    ...
    generator = Llama.build(
        ...
        tokenizer_path=os.path.join('/data/data_user_alpha/public_models/Llama_2_hf/Llama-2-7b-hf', 'tokenizer.model'),
        max_seq_len=args.max_gen_len,
        max_batch_size=4,
    )
    ...
    list_data_dict = jload('medmcqa_open_test.json')
    ...
    for x in sources:
        ...
        results.append(result[0]['generation'])
    ...
    ipdb.set_trace()
    with open('llama_usmle.json', 'w') as file:
